"""
# File: fastapi_template/app/common/schemas/pagination_schema.py
# Description: 페이지네이션 관련 스키마 정의
"""
...
from app.common.schemas.base_schema import OutputSchema
...
class PaginatedResponse(OutputSchema, Generic[T]):
    """
    페이지네이션 결과 응답 모델
    """
