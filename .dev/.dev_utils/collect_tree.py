...
def write_py_file_tree_with_top_folder(root_folder, output_file, types=["py"], no_ext_files=["Dockerfile", "requirements"], exclude_folders=[]):
...
if __name__ == "__main__":
    ...
    write_py_file_tree_with_top_folder(args.path, args.output, args.types, args.no_ext, args.exclude)